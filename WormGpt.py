...
admin = 6296157687 #ايدي المالك

chat_id = "MASRY103" #يوزر القناة بدون @

dev = "MASRY_official" #يوزر املك بدون @

token = "7266798327:AAH626sToxGLViVPHNHECaMx8L3LUWVv9dg" # توكن
...
def welcome(message):
    ...
    if any(["member" in x.text, "administrator" in x.text, "creator" in x.text]):
        ...
        if str(message.from_user.id) == str(admin):
    	    ...
    	    keyboard.row(Tho9)
    	    bot.reply_to(message, f"**• اهلا بك في لوحه المالك الخاصه بالبوت 🤖**\n\n- يمكنك التحكم في البوت الخاص بك من هنا \n\n=================== \n", reply_markup=keyboard)
